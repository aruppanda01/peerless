...
class CreditUserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.credit_user.index')->with($data);
    }
    ...
    {
        return view('admin.credit_user.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::beginTransaction();
        try {
            $credit_user = User::where('role_id', 2)->count();
            $num_padded = sprintf("%05d", ($credit_user + 1));
            $id_no = 'PFCU' . $num_padded;
    ...
    public function show($id)
    {
        ...
        return view('admin.credit_user.view')->with($data);
    }
    ...
    public function approval($id)
    {
        ...
        if ($user->status == 0) {
            $user->status = 1;
            $user->save();
            FacadesNotification::route('mail', $user->email)->notify(new WelcomeMail($user));
