...
class OperationUserController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('admin.operation_user.index')->with($data);
    }
    ...
    {
        return view('admin.operation_user.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::beginTransaction();
        try {
            $credit_user = User::where('role_id', 3)->count();
            $num_padded = sprintf("%05d", ($credit_user + 1));
            $id_no = 'PFOU' . $num_padded;
            ...
            DB::commit();
            return redirect()->route('admin.operation-user.index')->with('success','User Created Successfully');
        } catch (Exception $e) {
            DB::rollback();
            return 0;
        }
    ...
    public function show($id)
    {
        ...
        return view('admin.operation_user.view')->with($data);
    }
    ...
    public function edit($id)
    {
        $data = array();
        $data['user_details'] = User::find($id);
        return view('admin.operation_user.edit')->with($data);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            DB::commit();
            return redirect()->route('admin.operation-user.index')->with('success','User Details Updated Successfully');
        } catch (Exception $e) {
            DB::rollback();
            return 0;
        }
    ...
    {
        User::find($id)->delete();
        return redirect()->route('admin.operation-user.index')->with('success','User Deleted Successfully');
    }
