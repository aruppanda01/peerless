            ...
            <div class="app-main__inner">
                    ...
                    <div class="page-title-wrapper d-sm-flex justify-content-between">
                        ...
                        <div class="mr-3">
                            ...
                            @else
                                ...
                                @elseif ($user_details->deactivated == 1)
                ...
                <div class="tabs-animation">
                    <div class="bg-edit p-4">
                        @if ($user_details->status == 1 && $user_details->deactivated == 0)
                        ...
                        @elseif ($user_details->status == 1 && $user_details->deactivated == 1)
