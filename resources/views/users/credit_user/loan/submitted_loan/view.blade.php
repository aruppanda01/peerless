            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a
                            href="{{ route('credit_user.loan.index') }}">Loan List</a></li>
            ...
            <div class="col-12 col-lg-7 col-lg-7 shadow p-3 bg-light">
                <form action="{{ route('credit_user.loan.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="amount_O_s_as_on" disabled value="{{ $loan_details->amount_O_s_as_on }}">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="text" name="reasons_for_the_irregularity" value="{{ $loan_details->reasons_for_the_irregularity }}"
                        disabled>
                    </div>
                    <div class="form-group">
